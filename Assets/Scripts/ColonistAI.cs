...
public class ColonistAI : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //状態がEatじゃなくてストレスが限界を超えたら勝手に休憩に入る
    ...
    private void HandleMove()
    {
        ...
        //Transform自体をTargetPositionに向かせてあげる
    ...
    private void HandleRest()
    {
        ...
        {
            //Animation再生
            ColonistAnimatorController.PlayDancingAnimation();
    ...
    private void HandleSleep()
    {
        ...
        if (house != null)
        {
            ...
            if (Vector3.Distance(transform.position, targetPosition) < 0.1f)
            {
                ...
                //1秒間に8ポイントRecoveryBonnus分回復させる
                currentHealth += hunger *house.RecoveryBonus* 8f * Time.deltaTime;

                //1秒間に5ポイントRecoveryBonnus分ずつストレスが減る
